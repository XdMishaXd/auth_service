...
func (r *Repo) RegisterAtomicOp(ctx context.Context) (string, error) {
...
func (r *Repo) ExecuteAtomicOp(ctx context.Context, opID string, keys []string, args ...any) (any, error) {
